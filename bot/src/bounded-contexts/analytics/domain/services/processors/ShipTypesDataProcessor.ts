...
export class ShipTypesDataProcessor implements IChartDataProcessor {
   ...
   */
  private processShipTypesUsed(rawData: any[], config: ChartConfiguration): ChartData {
   ...
   */
  private processShipTypesDestroyed(rawData: any[], config: ChartConfiguration): ChartData {
    const shipTypeMap = new Map<string, number>();
   ...
   */
  private formatShipTypeData(shipTypeMap: Map<string, number>, config: ChartConfiguration, _title: string): ChartData {
